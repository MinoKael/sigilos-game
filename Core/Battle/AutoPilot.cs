...
{
	/// <summary>
	/// O automático (GDD, seção 7): usa a habilidade especial quando está pronta e mira com vantagem elemental e, no
	...
	///
	/// Inimigos usam a especial quando está pronta e miram ao acaso (com a semente da luta).
	/// </summary>
	public static class AutoPilot
	{
		public static UnitAction ForAlly(BattleSession session, BattleUnit actor)
		{
			var slot = actor.IsSpecialReady ? SkillSlot.Special : SkillSlot.Basic;
